...
for motoin_id, (amass_name, amass_data) in enumerate(amass_data_list.items()):
    ...
    root_transformation = motion.root_transformation_xh.clone()
    ...
    root_translation[:,2] = root_translation[:,2] - root_translation[0,2] # TODO
    root_translation[:,1] = root_translation[:,1] + 0.14
    ...
    for i in tqdm(range(global_translation.shape[0])):
        ...
        h1_dof_states['vel'] = dof_h1_vel[i] #TODO
