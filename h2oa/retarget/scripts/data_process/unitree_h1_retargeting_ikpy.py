...
# h1_asset_file = 'phc/data/assets/mjcf/h1.xml'
...
in_file='sample_data/amass_copycat_take6_test.pkl' 
...
left_leg_chain = ikpy.chain.Chain.from_urdf_file(asset_root+"h1_description/urdf/h1_with_wrist.urdf", base_elements=["pelvis", "left_hip_yaw_joint"], name="left leg" )
right_leg_chain = ikpy.chain.Chain.from_urdf_file(asset_root+"h1_description/urdf/h1_with_wrist.urdf", base_elements=["pelvis", "right_hip_yaw_joint"], name="right leg" )
left_arm_chain = ikpy.chain.Chain.from_urdf_file(asset_root+"h1_description/urdf/h1_with_wrist.urdf", base_elements=["pelvis", "left_shoulder_pitch_joint"], name="left arm" )
right_arm_chain = ikpy.chain.Chain.from_urdf_file(asset_root+"h1_description/urdf/h1_with_wrist.urdf", base_elements=["pelvis", "right_shoulder_pitch_joint"], name="right arm")
# forward kinematics
