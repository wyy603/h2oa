...
# test_file='/cephfs_yili/shared/xuehan/H1_RL/denoise_64_retarget_64_amass_train_13912.pkl'
...
test_file='/cephfs_yili/shared/xuehan/H1_RL/tracked_2036_0.15_0831_11112retar_tarinit_retarget_13911_amass_train_13912.pkl'
log_path = os.path.join(os.path.dirname(test_file), 'metrics.csv')
test_data_list0 = joblib.load(test_file) 

test_file='/cephfs_yili/shared/xuehan/H1_RL/tracked_1474_0.18_0831_11112retar_tarinit_retarget_13911_amass_train_13912.pkl'
log_path = os.path.join(os.path.dirname(test_file), 'metrics.csv')
test_data_list1 = joblib.load(test_file) 

test_file='/cephfs_yili/shared/xuehan/H1_RL/tracked_1803_0.21_0831_11112retar_tarinit_retarget_13911_amass_train_13912.pkl'
log_path = os.path.join(os.path.dirname(test_file), 'metrics.csv')
test_data_list2 = joblib.load(test_file) 

test_file='/cephfs_yili/shared/xuehan/H1_RL/tracked_1949_0.25_0831_11112retar_tarinit_retarget_13911_amass_train_13912.pkl'
log_path = os.path.join(os.path.dirname(test_file), 'metrics.csv')
test_data_list3 = joblib.load(test_file) 

test_file='/cephfs_yili/shared/xuehan/H1_RL/tracked_2020_0.32_0831_11112retar_tarinit_retarget_13911_amass_train_13912.pkl'
log_path = os.path.join(os.path.dirname(test_file), 'metrics.csv')
test_data_list4 = joblib.load(test_file) 

test_data_list = {**test_data_list0, **test_data_list1, **test_data_list2, **test_data_list3, **test_data_list4}
...
amass_file='/cephfs_yili/shared/xuehan/H1_RL/amass_train_13912.pkl' 
amass_data_list = joblib.load(amass_file) # dict_keys(['pose_aa', 'pose_6d', 'trans', 'beta', 'seq_name', 'gender'])
...
for test_id, (test_name, test_data) in tqdm(enumerate(test_data_list.items())):
