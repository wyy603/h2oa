...
def run(in_file: str, out_file: str):
    ...
    print(len(amass_full_motion_dict.keys()))
    return
...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_file", type=str, default="/cephfs_yili/shared/xuehan/PHC/sample_data/amass_phc_train.pkl")
    parser.add_argument("--out_file", type=str, default="/cephfs_yili/shared/xuehan/PHC/data/amass/pkls/amass_isaac_train_phc.pkl")
