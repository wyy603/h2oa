...
class Matplotlib3DPlotter(BasePlotter):
    ...
    # def __init__(self, task: "BasePlotterTask") -> None: NOTE(xh) change to latest poselib
    ...
    def __init__(self, task: "BasePlotterTask") -> None:
        # self._fig = plt.figure()
        # self._ax = p3.Axes3D(self._fig)
        self._fig, self._ax = plt.subplots(subplot_kw={"projection": "3d"}) # NOTE(xh) change to latest poselib
        self._artist_cache = {}
