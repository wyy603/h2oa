from galaxy_legged_gym.envs.base.legged_robot_config import LeggedRobotCfg, LeggedRobotCfgPPO


class H1LocoManipulationCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        ...
        plane_terrain = False
        # num_privileged_obs = 106
        num_observations = 68
        num_proprio = 68
        num_actions = 19
        num_torques = 19
        termination_roll = 0.8
    ...
    class commands(LeggedRobotCfg.commands):
        ...
        loco_command = False  # 3
        heading_command = False  # 1
        hand_touch_command = False  # 3
        squat_command = False  # 1
        pitch_command = False # 1 ***
        manip_command = False # 3
        manip_height_command = False
        loco_manip_command = True
        follow_traj_command = False
        mask = True
        ...
        visualize_loco_manip_command = False
        ...
        class ranges(LeggedRobotCfg.commands.ranges):
            ...
            loco_manip_command_x = [0.1, 0.5]
            loco_manip_command_y = [-0.5, 0.5]
            loco_manip_command_z = [0., 2.0]
            follow_traj_speed = [0.2, 0.3]
    ...
    class rewards(LeggedRobotCfg.rewards):
        ...
        class scales:
            ...
            # tracking_manip_height = 2.0
            # tracking_loco_manip_abs = 8.0
            tracking_loco_manip_square = 2.0
            tracking_precise_loco_manip = 2.0
            # mismatch_vel = 1.0
            ...
            # orientation = -5.
            collision = -5.
            hip_yaw_dof_error = 0.5
            # hip_roll_dof_error = 0.5 # in case knee too close
            feet_away = 0.5
            knee_away = 0.5 # in case knee too close
            # lin_vel_z = -0.5
            feet_close = 0.5
            # freeze_upper_body = -0.5
            # leap_forward = 5
            root_roll_negative = -0.5
            root_negative_pitch_negative = -0.5
            punish_large_vel = 0.2
            punish_sliding = 0.5
            # punish_sliding_v1 = 0.2
            # punish_sliding_negative = -0.5
            both_touch_ground = 0.5
            # any_touch_ground = 0.5

            # arm_dof_error = -1.0
            # waist_dof_error = -5.0
            # arm_dof_error_when_far = -1.0
            # waist_dof_error_when_far = -5.0
...
class H1LocoManipulationCfgPPO(LeggedRobotCfgPPO):
    seed = 42
