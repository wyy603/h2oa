...
from legged_gym.utils.terrain_h2o import Terrain
from legged_gym.privileged.observation import HistoryBuffer
from legged_gym.envs.h1.h1_h2o_config import H1RoughCfg
...
class H1Walk(BaseTask):
    ...
    def update_target_pkls(self, reset_env_ids):
        ...
        self.target_global_pos = self.target_global_pos + self.ref_episodic_offset.repeat(1,self.num_bodies)
    ...
    def _process_rigid_body_props(self, props, env_id):
        ...
        if self.cfg.domain_rand.randomize_link_mass:
            ...
            for i, body_name in enumerate(self.cfg.domain_rand.randomize_link_body_names):
                body_index = self.body_names_to_idx[body_name]
                assert body_index != -1
                ...
                link_mass_scale.append(mass_scale)
            link_mass_scale = np.array(link_mass_scale)
        ...
        mass_params = np.hstack([link_mass_scale, rand_com])
    ...
    def _create_envs(self):
        ...
        self.mass_params_tensor = torch.zeros(self.num_envs, 11, device=self.device, requires_grad=False)
