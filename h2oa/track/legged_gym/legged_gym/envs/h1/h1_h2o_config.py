...
class H1RoughCfg(LeggedRobotCfg):
    class human:
        ...
        # filename = '/home/ubuntu/data/PHC/rcp_10box_mdm.pkl'
        filename = '/home/ubuntu/data/MDM/pophm_10_swingwalk.pkl'
        # filename = '/home/ubuntu/data/MDM/pophm_35hand.pkl'
    ...
    class rewards(LeggedRobotCfg.rewards):
        ...
        class scales: # TODO
            ...
            orientation = -1. # NOTE target_projected_gravity error
            collision = -5.
            hip_yaw_dof_error = -5. # NOTE
            hip_roll_dof_error = -0. # NOTE
            feet_away = 1.0
            # lin_vel_z = -0.5
            # feet_close = -0.5
            ...
            waist_dof_error = -5.0 # NOTE
            arm_waist_ankle_hip_smoothness = -0.01
